...
export function GamePage (){
    ...
    return(
        <div className="min-h-screen flex w-full flex-col items-center justify-center text-center
            ...
            <div className="absolute w-full top-4 
                          ...
                          text-white">
                            ...
                            cursor-pointer " > 
                              ...
                              <button onClick={handleRestart}className="bg-red-500 text-white px-4 py-2
                              rounded-md mt-1">Restart</button>
                            </div>
...

                          {
                            ...
                            <div className="absolute inset-0 flex
                              item-centre justify-center bg-black bg-opacity-40">
